...
export const DateButtonGroup: FC<DateButtonGroupProps> = (
  props: DateButtonGroupProps
) => {
  return (
    <ButtonGroup variant="outlined">
      ...
      >
        <FormattedMessage
          description="Day chart option button text"
          defaultMessage="Day"
        />
      </Button>
      <Button
      ...
      >
        <FormattedMessage
          description="Week chart option button text"
          defaultMessage="Week"
        />
      </Button>
    </ButtonGroup>
