      ...
      </MuiAppBar>
      {
        userData && (
          <ProfileMenu
            ...
            nameText={userData ? userData.first_name + " " + userData.last_name : "unknown"}
            organization={userData && userData.organization ? userData.organization : "unknown organization"}
          />
        )
      }
      {
