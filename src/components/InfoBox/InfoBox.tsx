...
const cleanDataKey = (name: string): string =>
  name.split("_").map(capitalizeString).join(" ");
...
const InfoBox: FC<InfoBoxProps> = (props: InfoBoxProps) => {
  ...
  return (
    <TableContainer component={Paper}>
      <Typography variant="h5" align="center" style={{ paddingTop: "0.5em" }}>
        Basic Info
      </Typography>
      <Table size="small">
        <TableBody>
